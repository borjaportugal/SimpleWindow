        ...
        if (g.IO.MouseDown[0])
        {
            ...
            if (is_non_linear)
            {
                ...
                if (normalized_pos < linear_zero_pos)
                {
					...
					float a = 1.f;
					if (linear_zero_pos != 0.f)
						a = 1.0f - (normalized_pos / linear_zero_pos);
                    a = powf(a, power);
    ...
    case ImGuiColorEditMode_HEX:
        {
            ...
            i[0] = i[1] = i[2] = i[3] = 0;
            if (alpha)
                (void)sscanf(p, "%02X%02X%02X%02X", (unsigned int*)&i[0], (unsigned int*)&i[1], (unsigned int*)&i[2], (unsigned int*)&i[3]);
            else
